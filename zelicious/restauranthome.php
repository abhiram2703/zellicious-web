                      ...
                      <?php
                        ...
                        ?>
                            <form method="post">
                                ...
                                <input type="hidden" name="food_id_out" value="<?php echo $row['food_id']; ?>">
                            </form>
                        <?php
                        } else {
                        ?>
                            <form method="post">
                                ...
                                <input type="hidden" name="food_id_in" value="<?php echo $row['food_id']; ?>">
                            </form>
                        <?php
                        }
                        ?>
