<?php
    ...
    $query="select * from zeli_foods where food_outofstock=1";
    $foodout=mysqli_query($con, $query);

    $query="select * from zeli_foods where food_outofstock=0";
    $foodin=mysqli_query($con, $query);
...
<body>
  <header class="header">
    ...
    <?php
        displayFoodItems("Foods", $foodin, $foodout);
    ?>
    <script>
